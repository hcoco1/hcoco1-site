        ...
        <div className="card mb-3">
            <div className="row g-0">
                <div className="col-md-4">
                    <img src="https://avatars.githubusercontent.com/u/52940441?v=4" className="img-fluid rounded-start" alt="Profile"/>
                </div>
                <div className="col-md-8">
                    <div className="card-body">
                        <h5 className="card-title text-center">Ivan Arias</h5>
                        <h6 className="card-title text-center">Ivan Arias| Full Stack Development with Flask and React | Geologist |</h6>
                        ...
                        <a href="/src/assets/Ivan_ Resume.pdf" download className="btn btn-primary">Download CV</a> {/* Adjust the href to the path of your PDF */}
