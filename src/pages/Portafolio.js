                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        <div
                            ...
                            <div class="col p-4 d-flex flex-column position-static">
                                <strong class="d-inline-block mb-2 text-success">Coding</strong>
                                <h3 class="mb-0">My Web Site (latest version)</h3>
                                <div class="mb-1 text-muted">July 2023</div>
                                <p class="card-text mb-auto"> My last site looked good, but I wasn't happy with it. I always wanted
                                    ...
                                    I'm actively working on this site, but it is ready to be posted!! </p>
                                <a href="https://hcoco1-site.vercel.app" class="stretched-link"
                    ...
                    <div class="col-md-6">
                        <div
                            ...
                            <div class="col p-4 d-flex flex-column position-static">
                                <strong class="d-inline-block mb-2 text-success">Coding</strong>
                                <h3 class="mb-0">My Web Site (Bootstrap version)</h3>
                                <div class="mb-1 text-muted">Feb 2023</div>
                                <p class="card-text mb-auto">This website was created using a BOOTSTRAP template. I used React app to modify it with Bootstrap classes.
                                    ('https://startbootstrap.com/theme/resume') </p>
                                <a href="https://hcoco1.github.io/hcoco1-site-bootstrap/" class="stretched-link"
                                    target="_blank" rel="noopener noreferrer">Check it out!</a>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div
                            ...
                            <div class="col p-4 d-flex flex-column position-static">
                                <strong class="d-inline-block mb-2 text-success">Coding</strong>
                                <h3 class="mb-0">My Web Site (oldest version)</h3>
                                <div class="mb-1 text-muted">Sep 2022</div>
